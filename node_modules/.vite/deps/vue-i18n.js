...
var component = {
  ...
  render: function render(h, ref) {
    ...
    children.forEach(function(child, i2) {
      var key = everyPlace ? "" + child.data.attrs.place : "" + i2;
      params[key] = child;
    });
...
VueI18n.prototype.watchI18nData = function watchI18nData() {
  ...
  return this._vm.$watch("$data", function() {
    var i2 = self._dataListeners.length;
    while (i2--) {
      Vue.nextTick(function() {
        self._dataListeners[i2] && self._dataListeners[i2].$forceUpdate();
      });
    }
  }, { deep: true });
};
  ...
  if (args.length === 1) {
    if (typeof args[0] === "string") {
      ...
      options = Object.keys(args[0]).reduce(function(acc, key2) {
        var obj;
        if (numberFormatKeys.includes(key2)) {
